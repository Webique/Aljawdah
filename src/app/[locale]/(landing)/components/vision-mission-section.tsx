  ...
  return (
    <section className="bg-muted/30 relative overflow-hidden py-16 lg:py-20">
      <div className="container relative mx-auto px-4">
        {/* Vision Row - Text first, Image second */}
        <div className="mb-20 grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          >
            ...
            <div className="bg-secondary/20 absolute -start-6 -top-6 -z-10 h-full w-full rounded-3xl" />
          </m.div>
        </div>

        {/* Mission Row - Image first, Text second */}
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          >
            ...
            <div className="bg-primary/20 absolute -end-6 -top-6 -z-10 h-full w-full rounded-3xl" />
          </m.div>
